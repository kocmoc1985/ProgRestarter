 ...
 * @author KOCMOC
 */
public class ProgramCloser_B implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        ProgramCloser_B pc = new ProgramCloser_B();
    }
}
